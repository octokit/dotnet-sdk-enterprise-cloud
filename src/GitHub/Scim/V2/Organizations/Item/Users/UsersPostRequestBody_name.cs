...
namespace GitHub.Scim.V2.Organizations.Item.Users {
    ...
    public class UsersPostRequestBody_name : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="UsersPostRequestBody_name"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="UsersPostRequestBody_name"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UsersPostRequestBody_name CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UsersPostRequestBody_name();
        }
        /// <summary>
