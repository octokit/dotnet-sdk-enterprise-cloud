...
namespace GitHub.Models {
    ...
    public class AuditLogEvent : IAdditionalDataHolder, IParsable 
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AuditLogEvent_actor_location? ActorLocation { get; set; }
#nullable restore
#else
        public AuditLogEvent_actor_location ActorLocation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AuditLogEvent_config>? Config { get; set; }
#nullable restore
#else
        public List<AuditLogEvent_config> Config { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AuditLogEvent_config_was>? ConfigWas { get; set; }
#nullable restore
#else
        public List<AuditLogEvent_config_was> ConfigWas { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AuditLogEvent_data? Data { get; set; }
#nullable restore
#else
        public AuditLogEvent_data Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AuditLogEvent_events>? Events { get; set; }
#nullable restore
#else
        public List<AuditLogEvent_events> Events { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AuditLogEvent_events_were>? EventsWere { get; set; }
#nullable restore
#else
        public List<AuditLogEvent_events_were> EventsWere { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="AuditLogEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="AuditLogEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static AuditLogEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"actor_location", n => { ActorLocation = n.GetObjectValue<AuditLogEvent_actor_location>(AuditLogEvent_actor_location.CreateFromDiscriminatorValue); } },
                {"blocked_user", n => { BlockedUser = n.GetStringValue(); } },
                {"business", n => { Business = n.GetStringValue(); } },
                {"business_id", n => { BusinessId = n.GetIntValue(); } },
                {"config", n => { Config = n.GetCollectionOfObjectValues<AuditLogEvent_config>(AuditLogEvent_config.CreateFromDiscriminatorValue)?.ToList(); } },
                {"config_was", n => { ConfigWas = n.GetCollectionOfObjectValues<AuditLogEvent_config_was>(AuditLogEvent_config_was.CreateFromDiscriminatorValue)?.ToList(); } },
                {"content_type", n => { ContentType = n.GetStringValue(); } },
                {"created_at", n => { CreatedAt = n.GetIntValue(); } },
                {"data", n => { Data = n.GetObjectValue<AuditLogEvent_data>(AuditLogEvent_data.CreateFromDiscriminatorValue); } },
                ...
                {"events", n => { Events = n.GetCollectionOfObjectValues<AuditLogEvent_events>(AuditLogEvent_events.CreateFromDiscriminatorValue)?.ToList(); } },
                {"events_were", n => { EventsWere = n.GetCollectionOfObjectValues<AuditLogEvent_events_were>(AuditLogEvent_events_were.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<AuditLogEvent_actor_location>("actor_location", ActorLocation);
            ...
            writer.WriteCollectionOfObjectValues<AuditLogEvent_config>("config", Config);
            writer.WriteCollectionOfObjectValues<AuditLogEvent_config_was>("config_was", ConfigWas);
            writer.WriteStringValue("content_type", ContentType);
            writer.WriteIntValue("created_at", CreatedAt);
            writer.WriteObjectValue<AuditLogEvent_data>("data", Data);
            ...
            writer.WriteCollectionOfObjectValues<AuditLogEvent_events>("events", Events);
            writer.WriteCollectionOfObjectValues<AuditLogEvent_events_were>("events_were", EventsWere);
