...
namespace GitHub.Models {
    ...
    /// SCIM User List
    /// </summary>
    public class ScimUserList : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ScimUserList"/> and sets the default values.
        /// </summary>
        public ScimUserList()
        {
        ...
        public static ScimUserList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ScimUserList();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"Resources", n => { Resources = n.GetCollectionOfObjectValues<ScimUser>(ScimUser.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ScimUser>("Resources", Resources);
