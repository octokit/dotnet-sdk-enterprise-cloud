...
namespace GitHub.Models {
    ...
    public class GetConsumedLicenses_users : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="GetConsumedLicenses_users"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="GetConsumedLicenses_users"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static GetConsumedLicenses_users CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetConsumedLicenses_users();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"enterprise_server_emails", n => { EnterpriseServerEmails = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"enterprise_server_user", n => { EnterpriseServerUser = n.GetBoolValue(); } },
                {"enterprise_server_user_ids", n => { EnterpriseServerUserIds = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"github_com_enterprise_roles", n => { GithubComEnterpriseRoles = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"github_com_login", n => { GithubComLogin = n.GetStringValue(); } },
                {"github_com_member_roles", n => { GithubComMemberRoles = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"github_com_name", n => { GithubComName = n.GetStringValue(); } },
                {"github_com_orgs_with_pending_invites", n => { GithubComOrgsWithPendingInvites = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                ...
                {"github_com_verified_domain_emails", n => { GithubComVerifiedDomainEmails = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
