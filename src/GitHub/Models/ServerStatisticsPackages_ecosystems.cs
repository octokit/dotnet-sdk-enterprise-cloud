...
namespace GitHub.Models {
    ...
    public class ServerStatisticsPackages_ecosystems : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        public ServerStatisticsPackages_ecosystems_enabled? Enabled { get; set; }
        ...
        public ServerStatisticsPackages_ecosystems_name? Name { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="ServerStatisticsPackages_ecosystems"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ServerStatisticsPackages_ecosystems"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ServerStatisticsPackages_ecosystems CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ServerStatisticsPackages_ecosystems();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"enabled", n => { Enabled = n.GetEnumValue<ServerStatisticsPackages_ecosystems_enabled>(); } },
                {"internal_packages_count", n => { InternalPackagesCount = n.GetIntValue(); } },
                {"name", n => { Name = n.GetEnumValue<ServerStatisticsPackages_ecosystems_name>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ServerStatisticsPackages_ecosystems_enabled>("enabled", Enabled);
            writer.WriteIntValue("internal_packages_count", InternalPackagesCount);
            writer.WriteEnumValue<ServerStatisticsPackages_ecosystems_name>("name", Name);
