...
namespace GitHub.Models {
    ...
    /// </summary>
    public class ServerStatisticsActions : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ServerStatisticsActions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ServerStatisticsActions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ServerStatisticsActions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ServerStatisticsActions();
        }
        /// <summary>
