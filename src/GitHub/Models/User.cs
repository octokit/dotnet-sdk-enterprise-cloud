...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.UserName? Name { get; set; }
#nullable restore
#else
        public global::GitHub.Models.UserName Name { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.Models.User_schemas?>? Schemas { get; set; }
#nullable restore
#else
        public List<global::GitHub.Models.User_schemas?> Schemas { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Models.User"/> and sets the default values.
        /// </summary>
        public User()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Models.User"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Models.User CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Models.User();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "name", n => { Name = n.GetObjectValue<global::GitHub.Models.UserName>(global::GitHub.Models.UserName.CreateFromDiscriminatorValue); } },
                ...
                { "schemas", n => { Schemas = n.GetCollectionOfEnumValues<global::GitHub.Models.User_schemas>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.Models.UserName>("name", Name);
            writer.WriteCollectionOfObjectValues<global::GitHub.Models.Users>("roles", Roles);
            writer.WriteCollectionOfEnumValues<global::GitHub.Models.User_schemas>("schemas", Schemas);
