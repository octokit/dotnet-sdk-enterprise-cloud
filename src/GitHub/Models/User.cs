...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GitHub.Models.UserName? Name { get; set; }
#nullable restore
#else
        public GitHub.Models.UserName Name { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<User_schemas?>? Schemas { get; set; }
#nullable restore
#else
        public List<User_schemas?> Schemas { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"name", n => { Name = n.GetObjectValue<GitHub.Models.UserName>(GitHub.Models.UserName.CreateFromDiscriminatorValue); } },
                {"roles", n => { Roles = n.GetCollectionOfObjectValues<Users>(Users.CreateFromDiscriminatorValue)?.ToList(); } },
                {"schemas", n => { Schemas = n.GetCollectionOfEnumValues<User_schemas>()?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<GitHub.Models.UserName>("name", Name);
            writer.WriteCollectionOfObjectValues<Users>("roles", Roles);
            writer.WriteCollectionOfEnumValues<User_schemas>("schemas", Schemas);
