...
namespace GitHub.Models {
    ...
    public class GroupMapping_groups : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="GroupMapping_groups"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="GroupMapping_groups"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static GroupMapping_groups CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GroupMapping_groups();
        }
        /// <summary>
