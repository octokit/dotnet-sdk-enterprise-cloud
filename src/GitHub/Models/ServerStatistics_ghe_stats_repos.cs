...
namespace GitHub.Models {
    ...
    public class ServerStatistics_ghe_stats_repos : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ServerStatistics_ghe_stats_repos"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ServerStatistics_ghe_stats_repos"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ServerStatistics_ghe_stats_repos CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ServerStatistics_ghe_stats_repos();
        }
        /// <summary>
