...
#nullable restore
        ...
        public List<global::GitHub.Models.RepositoryRulesetBypassActor> BypassActors { get; set; }
#endif
        /// <summary>Conditions for an enterprise ruleset. The conditions object should contain either the `organization_id` or `organization_name` property and the `repository_name` or `repository_property` property. For branch and tag rulesets, the conditions object should also contain the `ref_name` property.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.EnterpriseRulesetConditions? Conditions { get; set; }
#nullable restore
#else
        public global::GitHub.Models.EnterpriseRulesetConditions Conditions { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody_target? Target { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody"/> and sets the default values.
        /// </summary>
        public RulesetsPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            Target = global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody_target.Branch;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "conditions", n => { Conditions = n.GetObjectValue<global::GitHub.Models.EnterpriseRulesetConditions>(global::GitHub.Models.EnterpriseRulesetConditions.CreateFromDiscriminatorValue); } },
                ...
                { "target", n => { Target = n.GetEnumValue<global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody_target>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.Models.EnterpriseRulesetConditions>("conditions", Conditions);
            ...
            writer.WriteEnumValue<global::GitHub.Enterprises.Item.Rulesets.RulesetsPostRequestBody_target>("target", Target);
