...
namespace GitHub.Enterprises.Item.Actions.Runners.Item.Labels {
    ...
    public class LabelsPutResponse : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="LabelsPutResponse"/> and sets the default values.
        /// </summary>
        ...
        public static LabelsPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LabelsPutResponse();
        }
        /// <summary>
