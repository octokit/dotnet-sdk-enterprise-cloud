...
namespace GitHub.Enterprises.Item.Actions.Runners.Item.Labels {
    ...
    public class LabelsPostResponse : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="LabelsPostResponse"/> and sets the default values.
        /// </summary>
        ...
        public static LabelsPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LabelsPostResponse();
        }
        /// <summary>
