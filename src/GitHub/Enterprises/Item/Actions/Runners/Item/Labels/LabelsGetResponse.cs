...
namespace GitHub.Enterprises.Item.Actions.Runners.Item.Labels {
    ...
    public class LabelsGetResponse : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="LabelsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static LabelsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LabelsGetResponse();
        }
        /// <summary>
