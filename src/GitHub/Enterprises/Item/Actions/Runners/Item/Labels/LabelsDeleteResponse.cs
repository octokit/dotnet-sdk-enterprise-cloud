...
namespace GitHub.Enterprises.Item.Actions.Runners.Item.Labels {
    ...
    public class LabelsDeleteResponse : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="LabelsDeleteResponse"/> and sets the default values.
        /// </summary>
        ...
        public static LabelsDeleteResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LabelsDeleteResponse();
        }
        /// <summary>
