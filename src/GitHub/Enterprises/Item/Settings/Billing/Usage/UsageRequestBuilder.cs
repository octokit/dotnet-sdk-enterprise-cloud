...
namespace GitHub.Enterprises.Item.Settings.Billing.Usage
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::GitHub.Models.BillingUsageReport?> GetAsync(Action<RequestConfiguration<global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.BillingUsageReport> GetAsync(Action<RequestConfiguration<global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Enterprises.Item.Settings.Billing.Usage.UsageRequestBuilder WithUrl(string rawUrl)
        {
