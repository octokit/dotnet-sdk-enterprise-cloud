...
namespace GitHub.Orgs.Item.Copilot.Billing.Selected_teams
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse"/></returns>
...
#nullable enable
        public async Task<global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse?> DeleteAsync(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse> DeleteAsync(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse>(requestInfo, global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostResponse> PostAsync(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostResponse>(requestInfo, global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &gt; [!NOTE]&gt; This endpoint is in beta and is subject to change.Cancels the Copilot seat assignment for all members of each team specified.This will cause the members of the specified team(s) to lose access to GitHub Copilot at the end of the current billing cycle, and the organization will not be billed further for those users.For more information about Copilot pricing, see &quot;[Pricing for GitHub Copilot](https://docs.github.com/enterprise-cloud@latest//billing/managing-billing-for-github-copilot/about-billing-for-github-copilot#about-billing-for-github-copilot)&quot;.For more information about disabling access to Copilot Business or Enterprise, see &quot;[Revoking access to GitHub Copilot for specific users in your organization](https://docs.github.com/enterprise-cloud@latest//copilot/managing-copilot/managing-access-for-copilot-in-your-organization#revoking-access-to-github-copilot-for-specific-users-in-your-organization)&quot;.Only organization owners can cancel Copilot seats for their organization members.OAuth app tokens and personal access tokens (classic) need either the `manage_billing:copilot` or `admin:org` scopes to use this endpoint.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
