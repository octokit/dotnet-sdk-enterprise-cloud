...
namespace GitHub.Orgs.Item.CodeSecurity.Configurations {
    ...
    public class ConfigurationsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public DetachRequestBuilder Detach
        {
            get => new DetachRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public WithConfiguration_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("configuration_id", position);
                return new WithConfiguration_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ConfigurationsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ConfigurationsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#nullable restore
            ...
            public GetTarget_typeQueryParameterType? TargetType { get; set; }
        }
    }
}
