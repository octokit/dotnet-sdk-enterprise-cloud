...
namespace GitHub.Orgs.Item.CodeSecurity.Configurations.Item.Defaults {
    ...
    public class DefaultsPutResponse : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="DefaultsPutResponse"/> and sets the default values.
        /// </summary>
        ...
        public static DefaultsPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DefaultsPutResponse();
        }
        /// <summary>
