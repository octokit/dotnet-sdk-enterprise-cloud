...
namespace GitHub.Orgs.Item.CodeSecurity.Configurations.Item.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A List&lt;CodeSecurityConfigurationRepositories&gt;</returns>
...
#nullable enable
        public async Task<List<CodeSecurityConfigurationRepositories>?> GetAsync(Action<RequestConfiguration<RepositoriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<CodeSecurityConfigurationRepositories>> GetAsync(Action<RequestConfiguration<RepositoriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<CodeSecurityConfigurationRepositories>(requestInfo, CodeSecurityConfigurationRepositories.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
