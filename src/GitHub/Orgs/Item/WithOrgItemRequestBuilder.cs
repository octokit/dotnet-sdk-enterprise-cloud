...
namespace GitHub.Orgs.Item {
    ...
    public class WithOrgItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public CredentialAuthorizationsRequestBuilder CredentialAuthorizations
        {
            get => new CredentialAuthorizationsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Fine_grained_permissionsRequestBuilder Fine_grained_permissions
        {
            get => new Fine_grained_permissionsRequestBuilder(PathParameters, RequestAdapter);
        }
