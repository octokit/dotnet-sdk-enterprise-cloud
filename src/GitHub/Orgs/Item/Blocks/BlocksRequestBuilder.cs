...
namespace GitHub.Orgs.Item.Blocks
{
    ...
    public partial class BlocksRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Blocks.Item.WithUsernameItemRequestBuilder"/></returns>
        public global::GitHub.Orgs.Item.Blocks.Item.WithUsernameItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.SimpleUser>?> GetAsync(Action<RequestConfiguration<global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder.BlocksRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.SimpleUser>> GetAsync(Action<RequestConfiguration<global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder.BlocksRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder.BlocksRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder.BlocksRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Blocks.BlocksRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List the users blocked by an organization.
        /// </summary>
