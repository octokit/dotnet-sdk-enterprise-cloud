...
namespace GitHub.Marketplace_listing.Stubbed.Plans
{
    ...
    public partial class PlansRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="global::GitHub.Marketplace_listing.Stubbed.Plans.Item.WithPlan_ItemRequestBuilder"/></returns>
        public global::GitHub.Marketplace_listing.Stubbed.Plans.Item.WithPlan_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("plan_id", position);
                return new global::GitHub.Marketplace_listing.Stubbed.Plans.Item.WithPlan_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.MarketplaceListingPlan>?> GetAsync(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder.PlansRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.MarketplaceListingPlan>> GetAsync(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder.PlansRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder.PlansRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder.PlansRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Marketplace_listing.Stubbed.Plans.PlansRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists all plans that are part of your GitHub Enterprise Cloud Marketplace listing.GitHub Apps must use a [JWT](https://docs.github.com/enterprise-cloud@latest//apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth apps must use [basic authentication](https://docs.github.com/enterprise-cloud@latest//rest/authentication/authenticating-to-the-rest-api#using-basic-authentication) with their client ID and client secret to access this endpoint.
        /// </summary>
