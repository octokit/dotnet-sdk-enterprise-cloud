...
namespace GitHub.Marketplace_listing.Plans.Item.Accounts
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.MarketplacePurchase>?> GetAsync(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder.AccountsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.MarketplacePurchase>> GetAsync(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder.AccountsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder.AccountsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder.AccountsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Marketplace_listing.Plans.Item.Accounts.AccountsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns user and organization accounts associated with the specified plan, including free plans. For per-seat pricing, you see the list of accounts that have purchased the plan, including the number of seats purchased. When someone submits a plan change that won&apos;t be processed until the end of their billing cycle, you will also see the upcoming pending change.GitHub Apps must use a [JWT](https://docs.github.com/enterprise-cloud@latest//apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth apps must use [basic authentication](https://docs.github.com/enterprise-cloud@latest//rest/authentication/authenticating-to-the-rest-api#using-basic-authentication) with their client ID and client secret to access this endpoint.
        /// </summary>
        ...
        public partial class AccountsRequestBuilderGetQueryParameters 
        {
            ...
            public global::GitHub.Marketplace_listing.Plans.Item.Accounts.GetDirectionQueryParameterType? Direction { get; set; }
            ...
            [QueryParameter("sort")]
            public global::GitHub.Marketplace_listing.Plans.Item.Accounts.GetSortQueryParameterType? Sort { get; set; }
        }
    }
}
