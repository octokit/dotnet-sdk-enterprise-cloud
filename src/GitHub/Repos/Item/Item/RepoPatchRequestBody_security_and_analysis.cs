...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RepoPatchRequestBody_security_and_analysis_secret_scanning_validity_checks? SecretScanningValidityChecks { get; set; }
#nullable restore
#else
        public RepoPatchRequestBody_security_and_analysis_secret_scanning_validity_checks SecretScanningValidityChecks { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"secret_scanning_validity_checks", n => { SecretScanningValidityChecks = n.GetObjectValue<RepoPatchRequestBody_security_and_analysis_secret_scanning_validity_checks>(RepoPatchRequestBody_security_and_analysis_secret_scanning_validity_checks.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<RepoPatchRequestBody_security_and_analysis_secret_scanning_validity_checks>("secret_scanning_validity_checks", SecretScanningValidityChecks);
