...
namespace GitHub.Repos.Item.Item.Import.Authors.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::GitHub.Models.PorterAuthor?> PatchAsync(global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.PorterAuthor> PatchAsync(global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Repos.Item.Item.Import.Authors.Item.WithAuthor_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
