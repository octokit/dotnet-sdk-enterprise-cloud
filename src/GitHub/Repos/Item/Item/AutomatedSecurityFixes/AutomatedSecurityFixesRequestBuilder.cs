...
namespace GitHub.Repos.Item.Item.AutomatedSecurityFixes
{
    ...
    public partial class AutomatedSecurityFixesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest//rest/repos/repos#disable-automated-security-fixes" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest//rest/repos/repos#check-if-automated-security-fixes-are-enabled-for-a-repository" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest//rest/repos/repos#enable-automated-security-fixes" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
