...
using GitHub.Teams.Item.TeamSync;
...
namespace GitHub.Teams.Item
{
    ...
    public partial class WithTeam_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHub.Teams.Item.TeamSync.TeamSyncRequestBuilder TeamSync
        {
            get => new global::GitHub.Teams.Item.TeamSync.TeamSyncRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// <summary>
        /// &gt; [!WARNING]&gt; **Deprecation notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the [Get a team by name](https://docs.github.com/enterprise-cloud@latest//rest/teams/teams#get-a-team-by-name) endpoint.
